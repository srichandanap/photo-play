...
const Header = () => {
  const [searchInputData, setSearchInputData] = useState("nature");  //to take input data from search bar
  ...
  const [oldHeader, setOldHeader] = useState(false);
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization: "563492ad6f9170000100000102c42546c09a4fcda7f40689d9932255"     //use the apikey you have generated
    },
  };
        ...
        <div className="maskImage">
          <div className="mask-inner">
            <div className="logo-img">
              ...
              <img src={require('../../assets/logoMobile.png')} className='logoMobile' alt="" />
            </div>
            ...
            <div className='searchPosition'>
              <form className='search-form' onSubmit={(event: any) => {
                ...
                <img src={require('../../assets/Search.png')} alt="image" className='searchMobileButton' />
              </form>
            </div>
          </div>
        </div>
